...
<div class="section users-edit">
  <p class="col s12 page-titles">Trending last 24 hours</p>
  <div class="row">
     <div class="col s12">
        <div class="card-content mt-2">
             ...
             <div class="card-alert card green lighten-5">
              <div class="card-content green-text">
                <p>Listen to trending music on Tunebump. Discover new artists around the globe</p>
              </div>
             </div>
             @else
             <table class="custom_table">
               <tbody>
                 ...
                 @foreach($data['hot'] as $music)
                  ...
                  @endphp
                 <tr class="row">
                   <td class="col s3 m1 mb-4 mt-3 padding-overview"><div class="custom_num">{{$j}}</div><a id="cc{{$music->id}}" class="custom_play" onclick="playFunction('{{$music->title}}--{{ $music->img}}--{{ $music->link}}--{{ $music->artist}}--{{$music->id}}')"></a><img src="{{ $music->img}}" width="75" height="75" style="margin-top: 1rem; border-radius:5px;"></td>
